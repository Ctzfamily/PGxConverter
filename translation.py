...
<b>Bot Cʀᴇᴀᴛᴇʀ By: @XForceFounder </b> \n 
"""
    ...
    UPGRADE_TEXT = "Contact : @XForceFounder"
    DOWNLOAD_START = "<b>File Now Downloading ⬇</b>"
    UPLOAD_START = "<b>File Now Uploading ⬆</b>"
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry Do You Think! I'll Upload It?"
    AFTER_SUCCESSFUL_UPLOAD_MSG = "<b>Thank you for Using Me... </b> \n <b> Join @XForcebots | @XForceNetwork </b>"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT : @XForceFounder "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @XForceFounder"
    ...
    HELP_USER = """Checkout The Available Commands Here \n\n Do Follow @MultiConverterBot If You Find This Bot Usefull."""
